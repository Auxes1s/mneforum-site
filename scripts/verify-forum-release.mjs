...
assert(photoSpeakers.length === 35, `Expected 35 supplied resource-person photos; found ${photoSpeakers.length}.`);
...
assert(rosterPhotoRecords.length === 32,
  `Expected 32 roster records with supplied portraits; found ${rosterPhotoRecords.length}.`);
...
assert((speakerManifest.match(/"manual-square-crop"/g) || []).length === 35,
